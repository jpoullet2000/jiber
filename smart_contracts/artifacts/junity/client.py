...
class JunityClient:
    """A class for interacting with the junity app providing high productivity and
    ...
    def __init__(
        ...
        *,
        ...
        """
        JunityClient can be created with an app_id to interact with an existing application, alternatively
